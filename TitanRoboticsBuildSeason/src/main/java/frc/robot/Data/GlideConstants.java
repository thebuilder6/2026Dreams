...
public class GlideConstants {
    ...
    private static final double Y_CENTER   = FIELD_WIDTH / 2.0;  
    ...
    public static final Map<String, GlidePoint> GLIDE_POINTS = Map.ofEntries(
        ...
        Map.entry("Blue Right Side Climb", 
            new GlidePoint("Blue Right Side Climb", new Pose2d(1.05, 2.88, Rotation2d.fromDegrees(180)))), // Facing Hub to score

        // Hub (Scoring Structure)
        Map.entry("Blue Hub Front", 
            new GlidePoint("Blue Hub Front", new Pose2d(5.60, 4.10, Rotation2d.fromDegrees(180)))), // Facing Hub to score
        Map.entry("Blue Hub Back", 
            new GlidePoint("Blue Hub Back", new Pose2d(2.60, 4.10, Rotation2d.fromDegrees(0)))),    // Protected zone
        ...
        Map.entry("Red Feeder Top", 
            new GlidePoint("Red Feeder Top", new Pose2d(FIELD_LENGTH - 1.50, 6.00, Rotation2d.fromDegrees(-145)))),
        Map.entry("Red Feeder Bottom", 
            new GlidePoint("Red Feeder Bottom", new Pose2d(FIELD_LENGTH - 1.50, 2.20, Rotation2d.fromDegrees(145)))),

        Map.entry("Red Left Side Climb", 
            new GlidePoint("Red Left Side Climb", new Pose2d(FIELD_LENGTH - 1.05, 2.88, Rotation2d.fromDegrees(0)))),

        // Hub (Scoring Structure)
        Map.entry("Red Hub Front", 
            new GlidePoint("Red Hub Front", new Pose2d(FIELD_LENGTH - 5.60, 4.10, Rotation2d.fromDegrees(0)))), // Facing Hub to score
        Map.entry("Red Hub Back", 
            new GlidePoint("Red Hub Back", new Pose2d(13.94, 4.10, Rotation2d.fromDegrees(180)))), // Protected zone
