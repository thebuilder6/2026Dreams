...
import frc.robot.Data.MechanismConstants.Intake;
...
public class IntakeIOSparkMax implements IntakeIO {
    ...
    public IntakeIOSparkMax() {
        ...
        wheelsConfig.smartCurrentLimit((int) Intake.STALL_CURRENT_LIMIT);
        ...
        hopperConfig.smartCurrentLimit((int) Intake.STALL_CURRENT_LIMIT);
