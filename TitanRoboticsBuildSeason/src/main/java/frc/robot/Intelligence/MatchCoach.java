...
public class MatchCoach implements Subsystem {
    ...
    public static synchronized MatchCoach getInstance() {
        if (instance == null) {
    ...
    public void update() {
        ...
        double pinDuration = ContactWatchdog.getInstance().getPinDuration();
        boolean warningActive = ContactWatchdog.getInstance().isWarningActive();
