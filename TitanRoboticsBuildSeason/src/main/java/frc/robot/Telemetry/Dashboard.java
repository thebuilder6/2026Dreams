...
public class Dashboard implements Subsystem {
    ...
    private static final DoubleSubscriber allySpeedSub = table.getDoubleTopic(SimDashboardKeys.ALLY_SPEED_PERCENT).subscribe(75.0);
    private static final DoubleSubscriber allyCountSub = table.getDoubleTopic(SimDashboardKeys.ALLY_COUNT).subscribe(0.0);
    ...
    private void setupLayout() {
        ...
        ensureNumberDefault(SimDashboardKeys.ALLY_COUNT, 0.0);
        ...
        SmartDashboard.putData(SimDashboardKeys.OPPONENT_COUNT_CHOOSER, opponentCountChooser);
        ...
        SmartDashboard.putData(SimDashboardKeys.ALLY_COUNT_CHOOSER, allyCountChooser);
    }
    ...
    public void update() {
        ...
        if (opponentCountChooser != null && opponentCountChooser.getSelected() != null) {
            ...
            if (lastSelectedChooserCount == null) {
                ...
                SmartDashboard.putNumber(SimDashboardKeys.OPPONENT_COUNT, chooserVal);
            }
        }
        ...
        if (allyCountChooser != null && allyCountChooser.getSelected() != null) {
            ...
            if (lastSelectedAllyChooserCount == null) {
                ...
                SmartDashboard.putNumber(SimDashboardKeys.ALLY_COUNT, chooserVal);
            }
        }
    ...
    public static void setOpponentCount(int count) {
        ...
        table.getDoubleTopic(SimDashboardKeys.OPPONENT_COUNT).publish().set(clamped);
        SmartDashboard.putNumber(SimDashboardKeys.OPPONENT_COUNT, clamped);
        String optName = clamped == 1 ? "1 Opponent Bot" : clamped + " Opponent Bots";
        SmartDashboard.putString(SimDashboardKeys.OPPONENT_COUNT_CHOOSER_SELECTED, optName);
    }
