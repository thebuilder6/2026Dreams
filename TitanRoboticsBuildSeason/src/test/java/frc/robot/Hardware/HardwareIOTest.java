...
import frc.robot.Hardware.Intake.IntakeIO.IntakeIOInputs;
...
public class HardwareIOTest {
    ...
    public void testDriveIOSimInputs() {
        frc.robot.Hardware.Drive.DriveIOSim driveSim = new frc.robot.Hardware.Drive.DriveIOSim();
        frc.robot.Hardware.Drive.DriveIO.DriveIOInputs inputs = new frc.robot.Hardware.Drive.DriveIO.DriveIOInputs();
    ...
    public void testVisionIOPhotonVisionInputs() {
        frc.robot.Hardware.Vision.VisionIOPhotonVision photonIO =
                new frc.robot.Hardware.Vision.VisionIOPhotonVision();
        VisionIOInputs inputs = new VisionIOInputs();
    ...
    public void testHardwareSparkMaxIOInstantiation() {
        ...
        assertDoesNotThrow(() -> {
            frc.robot.Hardware.Shooter.ShooterIOSparkMax shooterIO = new frc.robot.Hardware.Shooter.ShooterIOSparkMax();
            shooterIO.updateInputs(new ShooterIOInputs());
            shooterIO.stop();
        });

        assertDoesNotThrow(() -> {
            frc.robot.Hardware.Intake.IntakeIOSparkMax intakeIO = new frc.robot.Hardware.Intake.IntakeIOSparkMax();
